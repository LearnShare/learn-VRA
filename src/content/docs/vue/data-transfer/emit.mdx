...
我们已经在 [事件](../../component/template/event) 一节了解过处理 DOM 事件的方法。
...
``` vue title="toggle-button.vue" "change"
<template>
  <button
...
``` vue title="volumn-bar.vue" "update:volumn"
<template>
...
``` vue title="app.vue" "v-model:volumn"
<volumn-bar
